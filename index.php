...
<html>
    <head>
        ...
        <title>Viníciu Schlee Tessmann - Developer</title>
<!--
            ...
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#" class="scroll-link" data-id="about">Sobre</a></li>
            ...
            <li class="selected first-slide">
                <div class="cd-full-width">
                    <div class="tm-slide-content-div slide-caption">
                        <span>Conheça</span>
                        <h2>Vinícius Schlee Tessmann</h2>
                        <p>Gaúcho, amante de tecnologia, louco por café, e uma pitada de misantropia, eis a minha definição.</p>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="copyright-text">
                        <p>Copyright &copy; <?php echo date('Y'); ?> Vinícius Tessman 
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="social-icons">
                        <ul>
                            <li>
                                <a target="_blank" href="https://www.facebook.com/vinicius.schleetessmann"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="https://twitter.com/viniciustessman"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="https://www.linkedin.com/in/vin%C3%ADcius-schlee-tessmann-08b664b7/"><i class="fa fa-linkedin"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="https://www.instagram.com/poxatessmann/"><i class="fa fa-instagram"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="https://github.com/viniciustessmann"><i class="fa fa-github"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
